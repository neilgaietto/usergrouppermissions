function ApplyMediaUploadPermissions($scope, navigationService, notificationsService, $http) {

    // Variables used in the view.
    $scope.selectedUserType = $scope.currentNode.name;
    ...
    $scope.performApply = function () {
        ...
        var url = "/umbraco/backoffice/UGP/UserGroupPermissions/ApplyMediaUploadPermissions";
        var data = { "RoleId": id };
...
angular.module("umbraco").controller("UGP.ApplyMediaUploadPermissions", ApplyMediaUploadPermissions);